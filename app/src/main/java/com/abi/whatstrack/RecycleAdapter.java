...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.MyViewHolder> {
    ...
    private final FolderList[] lists;
...
//        v.startAnimation(animation);
    ...
    public RecycleAdapter(Context context, FolderList[] appLists) {
...
//        AppList appList = lists.get(position);
        if(lists[position]!=null) {
            holder.title.setText(lists[position].folderName);
            holder.imageView.setImageDrawable(lists[position].appDrawable());
            holder.size.setText(""+lists[position].folderSize()+" MB");
        }
